...
/**
 * GOOGLE INTERVIEW: get4096() can return 4096 byte from a file. implement the getRadomNum(int readNumber) to read some
 * data from the file. For example: getRadomNum(1000) will get the first 1000 bytes, call getRadomNum(1000) again will
 * return the next 1000 bytes.
 * 
 * @author boyi
 */
