 ...
 * @author boyi
 */
public class ZigZagIteratorOfTwoLists {

    private int currentIndex;

    List<Iterator<Integer>> iterators;

    public ZigZagIteratorOfTwoLists(List<Integer> v1, List<Integer> v2) {
    ...
    public int next() {
        ...
        Iterator<Integer> current = iterators.get(currentIndex++);
